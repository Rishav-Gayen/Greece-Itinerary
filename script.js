...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('tripForm').addEventListener('submit', function(e) {
    ...
    if (this.checkValidity()) {
      ...
      const formattedOutput = formatFormData(formData)
      console.log(formattedOutput);
      console.log('Flight Details:', formData.flightDetails);
      alert('Itinerary saved!'); // Uncomment if you want user feedback
    } else {
      // Handle invalid form
